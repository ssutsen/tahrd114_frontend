export function Component() {
  return (
    <div>
      ...
      <p>材料:</p>
      <ul>
        <li>高強度材料：採用金屬材料和耐磨塑膠材料，確保耐用性和使用壽命。</li>
        <li>輕便設計：整體輕量化設計，減少手部負擔，方便長時間使用。</li>
      </ul>
      <p>設計理念:</p>
      <ul>
        <li>
        ...
        <li>精密設計：替換式螺絲頭的安裝和拆卸簡便，保證操作的流暢性。</li>
        <li>安全性：防滑握把設計和穩固的螺絲頭固定機制，提升使用安全性。</li>
      </ul>
      <p>功能:</p>
      <ul>
        <li>高效操作：結合先進的CAD和CAM技術，大幅提升使用效率和精準度。</li>
        <li>多用途：提供多種螺絲規格，滿足不同工作需求。</li>
        <li>防遺失設計：有效降低螺絲頭遺失的機率，保證工作的連續性和效率。</li>
        <li>便捷替換：螺絲頭替換簡單快速，適合各種工作場景。</li>
      </ul>
    </div>
  );
}
